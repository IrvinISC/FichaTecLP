...
const datos_personalesRoutes = require('./routes/datos_personales_routes');
const nivel_estudiosRoutes = require('./routes/nivel_estudios_routes');
const datos_socioeconomicosRoutes = require('./routes/datos_socioeconomicos_routes');
const documentosRoutes = require('./routes/documentos_routes');
const app = express();
